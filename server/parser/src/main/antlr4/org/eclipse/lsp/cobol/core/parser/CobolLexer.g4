...
COMMA : C O M M A;
GENERIC_COMMENTS : C O M M E N T S;
...
GUID : GUID_BLOCK GUID_BLOCK MINUSCHAR GUID_BLOCK MINUSCHAR GUID_BLOCK MINUSCHAR GUID_BLOCK MINUSCHAR GUID_BLOCK GUID_BLOCK GUID_BLOCK MINUSCHAR;
...
fragment GUID_BLOCK
 : [0-9A-Fa-f] [0-9A-Fa-f] [0-9A-Fa-f] [0-9A-Fa-f0-9]
 ;
